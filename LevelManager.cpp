...
int** LevelManager::nextLevel(VertexArray& rVaLevel)
{
	...
	// This line loads the file with the name stored in levelToLoad
	...
	// Set type of primitive we are using
	...
	for (int x = 0; x < m_LevelSize.x; ++x)
	{
		for (int y = 0; y < m_LevelSize.y; ++y)
		{
			...
			// Which tile from the sprite sheet shoud we use
			...
			// Position ready for teh next four vertices
