...
SoundManager::SoundManager()
{
	...
	// The sound reduces steadily as the player moves farther away
...
{
	// Set listener position based on passed in info
	Listener::setPosition(listenerLocation.x, listenerLocation.y, 0.0f);

	switch (m_NextSound)
	{
	case 1:
		// Locate/move the source of teh sound
	...
	// Go back to 1 when third sound has been started
	if (m_NextSound > 3)
	{
		m_NextSound = 1;
	}
